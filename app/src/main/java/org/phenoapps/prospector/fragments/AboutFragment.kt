...
class AboutFragment : MaterialAboutFragment() {
    ...
    public override fun getMaterialAboutList(ctx: Context?): MaterialAboutList {
        ...
        ctx?.let { c ->
            ...
            appCardBuilder.addItem(ConvenienceBuilder.createVersionActionItem(c,
                ContextCompat.getDrawable(c, R.drawable.ic_about_info),
            ...
            appCardBuilder.addItem(MaterialAboutActionItem.Builder()
                ...
                .setOnClickAction { showChangelog(c, managedShow = false, rateButton = false) }
                .build())
            appCardBuilder.addItem(ConvenienceBuilder.createRateActionItem(c,
                ContextCompat.getDrawable(c, R.drawable.ic_about_rate),
            ...
            authorCardBuilder.addItem(ConvenienceBuilder.createEmailItem(c,
                ContextCompat.getDrawable(c, R.drawable.ic_about_email),
            ...
            authorCardBuilder.addItem(ConvenienceBuilder.createWebsiteActionItem(c,
                ContextCompat.getDrawable(c, R.drawable.ic_about_website),
                "PhenoApps.org",
                false,
...
//                .build())
    ...
    private fun showChangelog(context: Context?, managedShow: Boolean, rateButton: Boolean) {
        context?.let {
            ChangelogBuilder()
                ...
                .withOkButtonLabel(it.getString(R.string.zxing_button_ok)) // provide a custom ok button text if desired, default one is "OK"
...
//    }
    ...
    private fun openAppOrStore(packageName: String, ctx: Context?): MaterialAboutItemOnClickAction {
        return ctx?.let {
            ...
            return try {
                ...
                ConvenienceBuilder.createWebsiteOnClickAction(it, Uri.parse("https://play.google.com/store/apps/details?id=$packageName"))
            }
        } ?: MaterialAboutItemOnClickAction {  }
    }
}